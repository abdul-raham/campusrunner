...
import { Mail, Phone, MapPin, Lock, User, Hash, ArrowRight, CheckCircle2, AlertCircle, Zap } from 'lucide-react';
      ...
      >
        ...
        <div className="relative rounded-3xl border-2 border-emerald-300/50 bg-gradient-to-br from-emerald-50 via-emerald-50/95 to-teal-50/50 backdrop-blur-xl p-8 text-center space-y-6 shadow-2xl shadow-emerald-500/20 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute inset-0 rounded-3xl bg-gradient-to-br from-emerald-400/20 to-cyan-400/20"
          />
          ...
          >
            <motion.h2
              ...
              className="text-3xl font-black bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent"
            >
              Welcome, Runner! 🚀
            </motion.h2>
            ...
            >
              Pending verification from our admin team
            </motion.p>
            ...
            <motion.p
              ...
              className="text-xs text-emerald-600/70 pt-2"
            >
              Usually approved within 24 hours ⏱️
            </motion.p>
          </motion.div>
    ...
    >
      ...
      <div className="text-center space-y-2">
        ...
        <div>
          ...
          <p className="text-xs text-[#6B7280] mt-0.5">Start earning on campus today</p>
        </div>
      </div>
        ...
        <div className="flex gap-2 pt-4">
          ...
          >
            {loading ? (
              ...
              <>
                {currentStep === 3 ? 'Become a Runner' : 'Next'}
