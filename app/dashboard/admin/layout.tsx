...
import { Menu, X, LogOut, Home, ShoppingCart, Users, DollarSign, Settings } from 'lucide-react';
...
export default function AdminLayout({
  ...
  const navItems = [
    ...
    { href: '/dashboard/admin/runners', label: 'Runners', icon: Users },
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b">
            <h1 className="text-2xl font-bold text-primary">CampusRunner Admin</h1>
          </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b px-4 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex-1 flex justify-end">
            <p className="text-gray-600">Admin Panel • {user?.email}</p>
          </div>
        </header>
